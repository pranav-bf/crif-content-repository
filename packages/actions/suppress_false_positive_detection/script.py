def name():
    ...
    return "suppress-false-positive-detection"
...
def execute(input):
    ...
    payload = {
        ...
        "suppressfordays": input.get("suppressfordays"),
    }
    return incidentService.markFalsePositive(payload)
...
def inputschema():
    ...
    return {
        "type": "object",
        "required": ["incidentid", "suppressfordays"],
        "properties": {
            "incidentid": {
                "type": "string",
                "description": "Unique identifier of the incident to mark as false positive",
            },
            "suppressfordays": {
                "type": "number",
                "minimum": 1,
                "description": "Days to suppress future detections with the same artifact hash",
            }
        }
    }
